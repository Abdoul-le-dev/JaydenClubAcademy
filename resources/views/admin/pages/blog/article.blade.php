...
<div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
    ...
    <div class="mt-10 flex :flex-row justify-between items-center">
        <a href="{{ route('admin-blog-update',['id'=> $post->id])}}" class="rounded bg-[#4287f5] border-[#4287f5] p-2 text-white font_title_first text-xs mb-2">Modifier l'article</a>
        
        <a href="{{  route('admin-blog-delete',['id'=> $post->id])}}" class="rounded bg-red-500 border-red-500  p-2 text-white font_title_first text-xs mb-2">Supprimer l'article</a>
    </div>
