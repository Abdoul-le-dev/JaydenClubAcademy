            ...
            <div class="rd-navbar-main-container container">
              <!-- RD Navbar Nav-->
                                <ul class="rd-navbar-nav">
                                    ...
                                    <li class="rd-nav-item"><a class="rd-nav-link " href="">Actualité</a>
                                                                          
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="{{route('galerie-views')}}">Gallery</a>
                                                        
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="j">Effectif</a>
              ...
              <div class="">
                <li class="rd-nav-item"><a class="rd-nav-link" href="{{route('recrutement-view')}}">Admission</a>
