                ...
                <div class="rd-navbar-panel-inner container">
                    ...
                    <div class="rd-navbar-panel-item rd-navbar-panel-item-right">
                        <ul class="list-inline list-inline-bordered">
                            <li>
                                <!-- Select 2-->
                                <select class="select" name="lang" data-container-class="select-inline"
                                ...
                                <div class="cart-inline-toggled-outer">
                                    ...
                                    <button class="link link-cart cart-inline-toggle"
                                        data-rd-navbar-toggle="#cart-inline"><span
                                            class="link-cart-icon fa-phone-square"></span></button>
                                    <!-- Cart Inline-->
                                    <article class="cart-inline cart-inline-toggled" id="cart-inline">
                                        <div class="cart-inline-inner">
                                            ...
                                            <div class="cart-inline-footer flex flex-row">
                                                ...
                                                <a class="button button-md button-primary"
                                                    href="mailto::jaydenfootballacademy@gmail.com">:jaydenfootballacademy@gmail.com</a>
                                            </div>
                                        </div>
                                    </article>
                                </div>
                            ...
                            <li><a class="link link-icon link-icon-left link-classic"
                                    href="{{route('login.view')}}"><span
                                        class="icon fl-bigmug-line-login12"></span><span class="link-icon-text">Votre
                                        Compte</span></a></li>
                        </ul>
                    </div>
            ...
            <div class="rd-navbar-main">
                <div class="rd-navbar-main-top">
                    <div class="rd-navbar-main-container container">
                        <!-- RD Navbar Brand-->
                        <div class="rd-navbar-brand"><a class="brand" href="{{route('Home')}}"><img class="brand-logo "
                                    src="landing_assets/assets/image/logo_s_b.png" alt="" width="95" height="126"></a>
                        </div>
                        <!-- RD Navbar List-->
                        <ul class="rd-navbar-list">
                            <li class="rd-navbar-list-item"><a class="rd-navbar-list-links"><img
                                        src="landing_assets/assets/image/discipline.png" alt="discipline" width="75"
                                        height="42"></a></li>
                            <li class="rd-navbar-list-item"><a class="rd-navbar-list-links"><img
                                        src="landing_assets/assets/image/passion.png" alt="passion" width="88"
                                        height="45"></a></li>
                            <li class="rd-navbar-list-item"><a class="rd-navbar-list-links"><img
                                        src="landing_assets/assets/image/work-team.png" alt="work-team" width="70"
                                        height="45"></a></li>
                        </ul>
                        <!-- RD Navbar Search-->
                        <div class="rd-navbar-search">
                            <ul class="flex flex-row lg:ml-[70px]">
                                <li class="rd-navbar-list-item"><a class="rd-navbar-list-links"><img
                                            src="landing_assets/assets/image/soccer-game.png" alt="" width="75"
                                            height="42"></a></li>
                                <li class="rd-navbar-list-item"><a class="rd-navbar-list-links"><img
                                            src="landing_assets/assets/image/football (2).png" alt="" width="88"
                                            height="45"></a></li>
                                <li class="rd-navbar-list-item"><a class="rd-navbar-list-links"><img
                                            src="landing_assets/assets/image/football.png" alt="" width="79"
                                            height="52"></a></li>
                            </ul>
                ...
                <div class="rd-navbar-main-bottom rd-navbar-darker">
                    <div class="rd-navbar-main-container container">
                        ...
                        <ul class="rd-navbar-nav">
                                        ...
                                        <div class="rd-megamenu-item rd-megamenu-item-nav">
                                            ...
                                            <div class="rd-megamenu-list-outer">
                                                <ul class="rd-megamenu-list">
                                                    ...
                                                    <li class="rd-megamenu-list-item"><a class="rd-megamenu-list-link"
                                                            href="blog-elements.html">Blog Elements</a></li>
                                                    <li class="rd-megamenu-list-item"><a class="rd-megamenu-list-link"
                                                            href="sport-elements.html">Sport Elements</a></li>
                                                    <li class="rd-megamenu-list-item"><a class="rd-megamenu-list-link"
                                                            href="shop-elements.html">Shop Elements</a></li>
                                                    <li class="rd-megamenu-list-item"><a class="rd-megamenu-list-link"
                                                            href="404-error-page.html">404 Error Page</a></li>
                                                    <li class="rd-megamenu-list-item"><a class="rd-megamenu-list-link"
                                                ...
                                                <ul class="rd-megamenu-list">
                                                    ...
                                                    <li class="rd-megamenu-list-item"><a class="rd-megamenu-list-link"
                                                            href="login-and-register.html">Login and Register</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <article class="heading-component heading-component-simple">
                                                <div class="heading-component-inner">
                                                    <h5 class="heading-component-title">Latest News
                                                        ...
                                                        href="news-1.html">See all News</a>
                                                </div>
                                            </article>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <article class="post-classic">
                                                        <div class="post-classic-aside"><a class="post-classic-figure"
                                                                href="blog-post.html"><img src="" alt="" width="93"
                                                                    height="94"></a></div>
                                                        <div class="post-classic-main">
                                                            ...
                                                            <p class="post-classic-title"><a
                                                                    href="blog-post.html">Raheem Sterling turns the tide
                                                                    for Manchester</a></p>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <article class="post-classic">
                                                        ...
                                                        <div class="post-classic-main">
                                                            ...
                                                            <p class="post-classic-title"><a href="blog-post.html">Prem
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <article class="post-classic">
                                                        ...
                                                        <div class="post-classic-main">
                                                            ...
                                                            <p class="post-classic-title"><a href="blog-post.html">Good
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <article class="post-classic">
                                                        ...
                                                        <div class="post-classic-main">
                                                            ...
                                                            <p class="post-classic-title"><a
                                                                    href="blog-post.html">Liverpool in desperate need of
                                                                    backup players</a></p>
                                                            <div class="post-classic-time"><span
                                                                    class="icon mdi mdi-clock"></span>
                                                                <time datetime="2024">April 15, 2024</time>
                                    ...
                                    <article class="event-teaser rd-megamenu-footer">
                                        <div class="event-teaser-header">
                                            <div class="event-teaser-caption">
                                                ...
                                                <time class="event-teaser-time" datetime="2024">Saturday, December 31,
                                                    2024</time>
                                            </div>
                                            <div class="event-teaser-teams">
                                                <div class="event-teaser-team">
                                                    <div
                                                        ...
                                                        <div class="unit-left"><img class="event-teaser-team-image"
                                                                src="" alt="" width="38" height="50">
                                                        </div>
                                                        <div class="unit-body">
                                        ...
                                        <div class="event-teaser-countdown event-teaser-highlighted">
                                            ...
                                            <div class="countdown countdown-classic" data-type="until"
                                                data-time="31 Dec 2024 16:00" data-format="dhms" data-style="short">
                                            </div>
                                        </div>
                            ...
                            <li class="rd-nav-item active"><a class="rd-nav-link" href="#">Effectif</a>
                                <ul class="rd-menu rd-navbar-dropdown">
                                    <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                            href="{{route('nosJoueurs-view')}}">Joueurs</a>
                                    </li>
                                    <li class="rd-dropdown-item"><a class="rd-dropdown-link"
                                            href="{{route('staffs.view')}}">Staff</a>
                                    </li>
                                </ul>
                            </li>
                            </li>
